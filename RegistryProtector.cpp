...
NTSTATUS 
RegistryProtector::NotifyOnRegistryActions(
...
NTSTATUS RegistryProtectorEx::NotifyOnRegistryActions(_In_ PVOID CallbackContext, _In_opt_ PVOID Argument1, _In_opt_ PVOID Argument2)
{
	UNREFERENCED_PARAMETER(CallbackContext);
	UNREFERENCED_PARAMETER(Argument1);
	UNREFERENCED_PARAMETER(Argument2);
